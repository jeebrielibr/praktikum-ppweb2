...
<body>
    ...
    // echo 'Nama Customer : ' . $nama_customer;
        ...
        echo '<tr><td>Nama Customer</td><td>' . $customer . '</td></tr>';
        echo '<tr><td>Produk Pilihan</td><td>' . $produk . '</td></tr>';
        echo '<tr><td>Jumlah Beli</td><td>' . $jumlah . '</td></tr>';
        echo '<tr><td>Harga Satuan</td><td>Rp. ' . number_format($harga, 0, ',', '.') . '</td></tr>';
        echo '<tr><td>Total Belanja</td><td>Rp. ' . number_format($total, 0, ',', '.') . '</td></tr>';
        echo '</table>';
        echo '</div>';
    }
    ?>
